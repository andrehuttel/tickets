...
<template class="bg-green-500">
    ...
    <main>
        <div class="container-fluid background-image mt-10 pb-8" :style="{
                        ...
                        ? `linear-gradient(${primaryColor}, rgba(0, 0, 0, 0.8)), url(https://tailwindui.com/img/ecommerce-images/product-page-02-secondary-product-shot.jpg)`
                        : `linear-gradient(#FFFFFF, rgba(0, 0, 0, 0.8)), url(https://tailwindui.com/img/ecommerce-images/product-page-02-secondary-product-shot.jpg)`
                    }">
            <!-- Image gallery -->
                        ...
                        <div class="lg:flex items-center mt-auto">
                            ...
                            <div class="flex mt-4 sm:justify-center lg:mt-0 w-full xs:w-full">
                                <div class="flex items-center space-x-5 lg:pt-5">
                                    ...
                                    <a :href="event.link_share_whatsapp" class="text-white text-white-400 hover:text-white-900 dark:hover:text-white flex items-center">
                                    ...
                                    <a :href="event.link_share_facebook" class="text-white text-white-400 hover:text-white-900 dark:hover:text-white flex items-center">
                                    ...
                                    <a :href="event.link_share_twitter" class="text-white text-white-400 hover:text-white-900 dark:hover:text-white flex items-center">
            ...
            <div class="mx-auto max-w-2xl px-4 pb-8 pt-4 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-4">
                ...
                <div class="mt-4 lg:row-span-3 lg:mt-0">
                    ...
                    <div class="mt-8">
                        ...
                        <p class="text-black mt-4">{{ event.classification }}</p>
                    </div>
                ...
                <div class="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
                    ...
                    <div class="mt-8 flex items-center space-x-6">
                        <img :src="event.organizer_logo" :alt="event.organizer" class="h-20 rounded">
                        <div>
                            <p class="text-gray-600 font-bold md:text-2xl">{{ event.organizer }}</p>
                            <div class="lg:flex items-center mt-auto">
