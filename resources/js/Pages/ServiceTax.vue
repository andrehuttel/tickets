...
<template class="bg-green-100">
    <Head :title="'Taxa de Serviço - ' + storeTitle">
        ...
        <div class="flex justify-center items-center title-category">
            <div class="max-w-7xl w-full">
                <div class="container px-5 pt-8 lg:pt-none mx-auto">
                    <div class="pb-20"></div>
                    <h1 class="text-3xl font-semibold text-white">Taxa de Serviço</h1>
                </div>
            </div>
        </div>
    </div>
                ...
                <section class="text-gray-600 body-font">
                    <div class="container px-5 py-8 lg:pb-24 lg:pt-8 mx-auto">
                        <div class="flex flex-wrap">
                            <div v-if="getValue(data.config, 'STORE_CMS_SERVICE_TAX')" v-html="getValue(data.config, 'STORE_CMS_SERVICE_TAX')" class="w-full min-h-screen mt-6 overflow-hidden" />
                        </div>
                    </div>
                </section>
            </div>
