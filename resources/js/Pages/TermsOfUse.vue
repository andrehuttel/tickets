                ...
                <section class="text-gray-600 body-font">
                    <div class="container px-5 py-8 lg:pb-24 lg:pt-8 mx-auto">
                        <div class="flex flex-wrap">
                            <div v-if="getValue(data.config, 'STORE_CMS_TERMS_OF_USE')" v-html="getValue(data.config, 'STORE_CMS_TERMS_OF_USE')" class="w-full min-h-screen mt-6 overflow-hidden" />
                        </div>
                    </div>
                </section>
            </div>
