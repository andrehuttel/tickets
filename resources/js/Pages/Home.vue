...
const company_configs = props.company.company.configs;

console.log('Dados da empresa:', company_configs);

const primaryColorObject = company_configs.find(config => config.key === 'primary_color');

if (primaryColorObject !== undefined) {
  const primaryColor = primaryColorObject.value;
  console.log('O valor de primary_color é:', primaryColor);
} else {
  console.log('A chave primary_color não foi encontrada ou não possui um valor.');
}
</script>
...
<template>
    ...
    <!-- <template> -->
        <p>Primary color é: {{ primaryColor }}</p>
