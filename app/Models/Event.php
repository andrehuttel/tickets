...
class Event extends Model
{
    ...
    'description_append', 'image', 'event_map_image', 'category_id', 'category_name', 'category_uri', 'group_id', 'group_name',
    'group_uri', 'place_id', 'place_name', 'place_address', 'organizer_id', 'organizer_name', 'organizer_logo',
